...
public enum Text {
    ...
    spawn_noHit("spawn.noHit"),
    spawn_noInteract("spawn.noInteract"),
    spawn_noBuild("spawn.noBuild"),
    spawn_noDestroy("spawn.noDestroy"),
    spawn_bypass_turnedOn("spawn.bypass.turnedOn"),
    spawn_bypass_turnedOff("spawn.bypass.turnedOff"),
    admin_command_chest_playerNotOnline("admin.commands.chest.playerNotOnline"),
    ...
    command_sign_text("commands.sign.text"),
    ...
    admin_command_freeze_frozen("admin.commands.freeze.frozen"),
    admin_command_freeze_targetFrozen("admin.commands.freeze.targetFrozen"),
    admin_command_freeze_unfrozen("admin.commands.freeze.unfrozen"),
    admin_command_freeze_targetUnfrozen("admin.commands.freeze.targetUnfrozen"),
    admin_command_freeze_alreadyFrozen("admin.commands.freeze.alreadyFrozen"),
    admin_command_freeze_notFrozen("admin.commands.freeze.notFrozen"),
    admin_command_chest_senderIsTarget("admin.commands.chest.senderIsTarget"),
    admin_command_mute_alreadyMuted("admin.commands.mute.alreadyMuted"),
    admin_command_mute_notMuted("admin.commands.mute.notMuted"),
    admin_command_mute_muted("admin.commands.mute.muted"),
    admin_command_mute_unmuted("admin.commands.mute.unmuted"),
    admin_command_mute_targetMuted("admin.commands.mute.targetMuted"),
    admin_command_mute_targetUnmuted("admin.commands.mute.targetUnmuted"),
    admin_command_mute_isMuted("admin.commands.mute.isMuted"),
